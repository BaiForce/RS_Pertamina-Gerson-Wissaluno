    ...
    public function index(Request $request)
{
    ...
    $no = 1;
    return view('laporan.index', compact('transaction', 'no', 'overallTotal', 'thisMonthTotal', 'todayTotal', 'status1OverallCount', 'status1ThisMonthCount', 'status1TodayCount', 'status2OverallCount', 'status2ThisMonthCount', 'status2TodayCount'));
}
