                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('transactions.update', $transaction->id) }}" method="POST" class="needs-validation" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('driver_id') is-invalid @enderror" name="driver_id" id="driver_id" required>
                                        <option value="">Pilih Driver</option>
                                        @foreach ($driver as $d)
                                            <option value="{{ $d->id }}" {{ $transaction->driver_id == $d->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('rute_id') is-invalid @enderror" name="rute_id" id="rute_id" required>
                                        <option value="">Pilih Rute</option>
                                        @foreach ($rutes as $rute)
                                            <option value="{{ $rute->id }}" {{ $transaction->rute_id == $rute->id ? 'selected' : '' }}>
